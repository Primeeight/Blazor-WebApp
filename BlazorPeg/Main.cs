public class ProgramStart
{
        ...
        static bool TestSolutionTesting(BFSProgram program)
        {
                return program.checkSolution(program.stateMap) == false;
        }

        static bool TestDictionaryCreation(BFSProgram program)
        {
        ...
        static bool TestGetThirdPoint(BFSProgram program)
        {
        ...
        static bool TestMove(BFSProgram program)
        {
        ...
        static bool TestChildernGeneration(BFSProgram program)
        {
                int[][] currState = program.stateMap;
                Node node = new Node();
                node.setState(currState);
        ...
        static bool TestBfs(BFSProgram program)
        {
                program.init();
